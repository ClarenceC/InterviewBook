...
[解决IE低版本对H5兼容性问题](https://juejin.im/post/5cfc64bdf265da1bc5525630)

#### 用 CSS 生成三个形

1. [CSS三角形產生器](http://apps.eky.hk/css-triangle-generator/zh-hant)

2. [【转】纯CSS画的基本图形（矩形、圆形、三角形、多边形、爱心、八卦等），NB么](https://www.cnblogs.com/jscode/archive/2012/10/19/2730905.html)

3. [如何用css画三角形](https://segmentfault.com/a/1190000005715074)
